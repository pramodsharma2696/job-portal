            ...
            <div>
                <div
                    ...
                    <div class="flex-1 flex items-center border-r">
                        ...
                        <input v-model="jobTitle" placeholder="Job title or keyword"
                    ...
                    <button @click="triggerSearch" class="bg-brand px-6 text-sm font-medium py-2 rounded-full text-white mr-3">Find
                        jobs</button>
                </div>
            </div>
        </div>
...
const jobTitle = ref('');
const location = ref('');
// Define event emitter to send search data to parent
